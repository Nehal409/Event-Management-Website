...
export class initialMigration1683913010228 implements MigrationInterface {
    name = 'initialMigration1683913010228'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`billing_details\` (\`id\` varchar(50) NOT NULL, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`phone\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`cnic\` varchar(255) NOT NULL, \`bookingDate\` date NOT NULL, \`billingTypeId\` varchar(50) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`otp\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`createdDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`expireDate\` timestamp NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
